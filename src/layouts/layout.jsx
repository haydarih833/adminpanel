    ...
    return (
        <div className='mt-5'>
            ...
            <div className='w-11/12 mx-auto gap-5 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4'>
                <div className='w-full h-52 bg-slate-400 rounded-2xl'></div>
            ...
            <div className=' bg-emerald-900 w-11/12 h-96 mx-auto mt-5 rounded-2xl '>
                <UserTable dataToShow={dataToShow} />
            </div>
        </div>
    )
}
